...
public final class SNMP4JSettings {
  ...
  /**
   * Specifies how the security level of retry requests after a REPORT PDU is
   * set.
   */
  ...
  /**
   * This flag enables/disables (default) whether REPORT PDUs should be sent by
   ...
   * is set.
   * @param millis
   *    the maximum time in milliseconds to wait for a Thread to join if no
