...
public class MPv3 implements MessageProcessingModel, EngineIdCacheSize {
    ...
    protected static class Cache {
        ...
        public synchronized boolean deleteEntry(PduHandle pduHandle) {
            ...
            if (e != null) {
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug("Removed cache entry: " + e + " for PduHandle "+pduHandle);
                }
            }
            ...
            if (pduHandleReference != null) {
                ...
                if (pduHandle != null) {
                    ...
                    if ((e != null) && (e.isMatchingMessageID(messageID))) {
                        ...
                        if (logger.isDebugEnabled()) {
                            logger.debug("Popped cache entry: " + e + " for msgID "+messageID);
                        }
                        return e;
                    }
                }
                ...
                logger.debug("No cache entry found for popEntry by msgID=" + messageID);
            }
            return null;
        }
    }
     ...
     *         the maximum size of the report message (will be most likely ignored because a report should always fit
     *         in 484  bytes).
